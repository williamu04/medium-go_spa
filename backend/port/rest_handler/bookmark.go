...
type BookmarkRestAPIHandler struct {
	logger                     *pkg.Logger
	BookmarkCreateUseCase      *bookmarkapplication.CreateBookmarkUseCase
	BookmarkRetrieveUseCase    *bookmarkapplication.RetrieveBookmarkUseCase
	BookmarkRetrieveAllUseCase *bookmarkapplication.RetrieveAllBookmarkUseCase
	BookmarkDeleteUseCase      *bookmarkapplication.DeleteBookmarkUseCase
	authMiddleware             *middleware.AuthMiddleware
}

func NewBookmarkRestAPIHandler(
	logger *pkg.Logger,
	BookmarkUseCase *bookmarkapplication.BookmarkUseCase,
...
func (h *BookmarkRestAPIHandler) BookmarkCreate(c *gin.Context) {
	...
	output, err := h.BookmarkCreateUseCase.Execute(c.Request.Context(), &bookmarkapplication.CreateBookmarkInput{
		UserID:    userID,
