...
type FollowRestAPIHandler struct {
	logger                   *pkg.Logger
	followCreateUseCase      *follow_application.CreateFollowUseCase
	followRetrieveUseCase    *follow_application.RetrieveFollowUseCase
	followRetrieveAllUseCase *follow_application.RetrieveAllFollowUseCase
	followDeleteUseCase      *follow_application.DeleteFollowUseCase
	authMiddleware           *middleware.AuthMiddleware
}

func NewfollowRestAPIHandler(
	logger *pkg.Logger,
	useCase *follow_application.FollowUseCase,
...
func (h *FollowRestAPIHandler) FollowCreate(c *gin.Context) {
	...
	output, err := h.followCreateUseCase.Execute(c.Request.Context(), &follow_application.CreateFollowInput{
		FollowingID:  uint(id),
